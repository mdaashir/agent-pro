...
- **[AI/ML Engineering Expert](agents/ai-ml-engineering-expert.agent.md)** 🔥 NEW - Agentic AI, MLOps, PyTorch, RAG
...
- **[Data Engineering Expert](agents/data-engineering-expert.agent.md)** 🔥 NEW - dbt, Airflow, Snowflake, Data Mesh
- **[Design Patterns Expert](agents/design-patterns-expert.agent.md)** - SOLID, GoF 23 patterns
- **[Design Systems Expert](agents/design-systems-expert.agent.md)** 🔥 NEW - Figma Variables, Design Tokens
...
- **[Mobile Development Expert](agents/mobile-development-expert.agent.md)** 🔥 NEW - React Native, Flutter, iOS, Android
...
- **[Platform Engineering Expert](agents/platform-engineering-expert.agent.md)** 🔥 NEW - Backstage IDP, Golden Paths
...
- **[Systems Programming Expert](agents/systems-programming-expert.agent.md)** 🔥 NEW - Rust, WebAssembly
...
1. 🧠 **AI/ML Engineering Expert** - Agentic AI, MLOps, RAG systems
2. 📱 **Mobile Development Expert** - React Native, Flutter, iOS, Android
3. ⚙️ **Platform Engineering Expert** - Backstage IDP, Golden Paths
4. 💾 **Data Engineering Expert** - Modern data stack, Data Mesh
5. 🎨 **Design Systems Expert** - Figma Variables, Code Connect
6. 🔧 **Systems Programming Expert** - Rust, WebAssembly, memory safety
